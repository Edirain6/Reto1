...
public class AddUserForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbDocumentType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cédula ciudadania", "Cédula extranjería", "Libreta militar", "Pasaporte", "Otro" }));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtLastname, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
                                .addComponent(txtDocument, javax.swing.GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        int posicionLista = cbDocumentType.getSelectedIndex();
        ...
        if(nombre.isEmpty() || apellidos.isEmpty() || documento.isEmpty() ||correo.isEmpty()){
            ...
            try {
                ...
                //Cuando se crea un empleado se edita un stament
            ...
            this.dispose();
            System.out.println("Nombre: " + nombre + " " + apellidos + ", Documento: " + posicionLista + " " + documento + " " + "; correo");
        }
